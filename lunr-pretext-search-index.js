...
},
{
  ...
  "body": " First-time Registration  If you are a new Runestone user, you will need to register for a free account. Click on the Login button at https:\/\/runestone.academy and then click on the Register link at the bottom of the login form or go directly to the registration page at https:\/\/runestone.academy\/admin\/auth\/register . Make sure you fill in the Institution Name because this will be used to suggest courses for you to join at your institution. Click the Create Account button to go to the second page to choose your first course.  If you check \"I am an instructor and want to create a course for my students\" at the bottom of the registration form, you will be taken to the create a new course page.  On the second page, you will see suggested courses from your institution. Or you can type in the name of a course you want to join. Or choose one from the list of base courses which are also listed on the library page . After joining your first course, you will be able to add more courses.   Register and Choose Course    "
},
{
  "id": "reg_yourself",
  "level": "2",
  ...
  "number": "2.2.1",
  "title": "",
  "body": " Register and Choose Course   "
},
{
  ...
  "body": " Add an Additional Course  When you are logged in and looking at an eBook, click on the person icon in the upper right and select Change Course . That will take you to the My Courses page where you can switch to another course or enroll in a new course using the \"Enroll in Another Course\" button at the bottom of the page. The courses that you have recently used are at the top and marked by a clock icon.   Change Courses    Click on the Enroll in a Course button, which takes you to a page that looks a lot like the registration choose a course page. You can enter a course name or choose another base course.  As an instructor you may find that the list of courses can get quite long. You can use the Drop button next to any course to unenroll yourself from that course, but make sure that you are first in an another active course. Please note it does NOT delete the course it only takes you out of it. You can always re-enroll at a later time. You cannot drop the course that you are currently active in without first switching to another active course.  "
},
{
...
},
{
  ...
  "body": " How to Create a course     Log in to Runestone by clicking on the Login button at https:\/\/runestone.academy if you already have an account with Runestone Academy. If you don't have an account then you can create one at https:\/\/runestone.academy\/admin\/auth\/register . When you register, it will ask to enter the name of an ebook. You can enter the name for any of the existing ebooks.  Figure 1: The login screen for Runestone Academy       Go to the Instructor Dashboard from the user menu or the links at the bottom of the Course Home Page and click on the Create a Course link or go directly to the Build a course Page at https:\/\/runestone.academy\/admin\/instructor\/create_course . Enter a description and the name of your institution. Choose a base course. A unique course name will be suggested for you. You can change this name, but make sure that it is unique. You may want to include your institution and a semester and year as part of the unique name. Scroll down and check the other options and then click Submit .  Figure 2: The Create a Course Page     Of special note is the checkbox just above the submit button. This says that you would like to support Runestone at the rate of $10 \/ student from your department or school. This is totally VOLUNTARY! If you check the box you will get an invoice from us about a week after the starting date you entered for your course. If you can't pay or do not wish to pay simply do not check the box. It is fine either way, but we would love your support if you are able.   Support Runestone      Success!  Build Successful     The successful build page reminds you of some resources that you can use to get help. Please do not use email. Please check for and file problems on Github or with the new Problem Reporting page from the user icon menu. Many problems are duplicates and have already have workarounds or explanations.    Your students can register for your course by using the unique name that you used when you created your course when they register at https:\/\/runestone.academy\/admin\/auth\/register . If they already have an account on Runestone Academy, they can simply add another course using the new course name by selecting Change Course from the user icon menu or by going to My Courses page and then clicking on Enroll in Another Course .  My Courses Page to Change Course        We will also cover how you can pre-register your students with a CSV file in another section.  This video demonstrates the process of creating a new course in the older interface:   "
},
{
  "id": "login_screen_fig",
  "level": "2",
...
},
{
  ...
  "number": "3.2.2",
  "title": "",
  "body": " Figure 2: The Create a Course Page   "
},
{
...
},
{
  ...
  "number": "3.2.5",
  "title": "",
  "body": " My Courses Page to Change Course   "
},
{
...
},
{
  ...
  "number": "",
  "title": "",
  "body": "Remove LTI 1.3 Association Admin > LTI Integration "
},
{
...
},
{
  ...
  "body": " Add and Instructor or TA  Runestone supports multiple instructors or TAs for a course. We do not make any real distinction between a TA and an instructor so keep in mind they they both have all of the same privileges that you do. Adding a another instructor is quite easy. The process is as follows.  Make sure that your co-instructor has registered for your course as a student.  From the user icon at the top right of the page, choose the Instructor Dashboard. Open the \"Course Administration\" section, and click on \"Manage Teaching Assistants\".    Select the co-instructor or TA from the list of students on the right then click the Add button below the list. You should see the name appear in the list of instructors on the left.   To \"demote\" a co-instructor or TA back to a student just select them in the list of instructors on the left and click the Remove button below the box.   "
},
{
  "id": "course_settings",
  "level": "1",
...
{
  "id": "instructor-interface_creating-a-problem-assignment-10",
  "level": "2",
  "url": "instructor-interface_create-an-assignment.html#instructor-interface_creating-a-problem-assignment-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Flag Question "
...
{
  "id": "instructor-interface_creating-a-problem-assignment-14",
  "level": "2",
  "url": "instructor-interface_create-an-assignment.html#instructor-interface_creating-a-problem-assignment-14",
  "type": "Warning",
  "number": "6.2.10",
...
},
{
  ...
  "number": "6.5",
  "title": "Grading",
  "body": " Grading   Grade Book  To see the Grade Book, go to the Instructor Dashboard and click on Grade Book.   Gradebook    The gradebook allows filtering by students or assignments. If you click on a student's grade, you can drill down to see their performance on each exercise and override the grade total. You can click on each exercise to open them in the grader.   Gradebook Drill Down on Assignment Score    Many assignments can be automatically graded, with the grades automatically appearing in the gradebook. For exercises in an assignment to be autograded, the assignment must be visible and completed before the deadline, and the exercises must be the type of exercises that support autograding. For example, the book active code exercises in the ebooks CSAwesome and CSAwesome2 all have unit tests that support autograding, but the community-contributed exercises and exercises from other books might not have unit tests. When you add an active code exercise to an assignment, you can tell if it has autograding tests if it comes up as \"Pct Correct\" in the Autograde colum and presents the autograding test results when run. Otherwise, it can be added as \"interaction\" only without grading for correctness or for \"manual\" grading. Short answer questions can be autograded for interaction, but require manual grading for content.  For assignments that are not autograded, you can manually grade the students' work. You can also manually grade any assignment, even if it is autograded, to override the automatic grading or for late work after the deadline.    Grader  To grade or examine student work, click on the Grader button in the Instructor's Dashboard. You will see your assignments in the Cards View. You can switch to the Table View by clicking on the Table View button at the top right, and then you can search for an assignment by name or description. You can also sort the assignments by clicking on the column headers.   Grader: Choose an Assignment    Click on an assignment to view the problems in the assignment in Cards or Table view. In this view, there are options to select all of the problems and Regrade all and to release the grades to the students.   Grader: Choose a Problem    From here, you can also select an exercise to view student solutions and to manually grade them. In the manual grading view, you can see the students' solutions, override autograded scores, and provide comments.   Grader: Manual Grading    In active code exercises, this view will show the last version of code that the student ran prior to the assignment deadline. Click run to execute it. Drag the little scrubber across the timeline next to the Run button to see other versions of the code that the student ran.  You can assign or change the grades next to \"Points\" in the rightmost panel, and, optionally, leave a comment. If you erase the \"autograded\" comment, it will no longer be autograded on regrades. Once you have manually graded the assignment or released grades, they will no longer be autograded. You will need to run the grader again for late work.  When you are satisfied that the grades have been calculated correctly, click on the toggle \"Grades Hidden\" button at the top right of the assignment view showing all the exercises in an assignment in the Grader, to switch it to Released. This makes them visible to students.  Students will see their grades and comments when they view their assignment. They will see your comments above each exercise in the assignment. They can also choose Progress from the user icon menu to see a summary of their grades on all assignments.  If you prefer to start grading by student and drill down instead of starting with the assignments, start with the Gradebook interface and click on a student's score in an assignment to see a breakdown, and click on a specific problem to view the student's solution in the Grader.   "
},
{
  "id": "gradebook",
  "level": "2",
  "url": "instructor-interface_grading.html#gradebook",
  "type": "Figure",
  "number": "6.5.1",
  "title": "",
  "body": " Gradebook   "
...
{
  "id": "gradebook_drilldown",
  "level": "2",
  "url": "instructor-interface_grading.html#gradebook_drilldown",
  "type": "Figure",
  "number": "6.5.2",
  "title": "",
  "body": " Gradebook Drill Down on Assignment Score   "
},
{
  "id": "grader1",
  "level": "2",
  "url": "instructor-interface_grading.html#grader1",
  "type": "Figure",
  "number": "6.5.3",
  "title": "",
  "body": " Grader: Choose an Assignment   "
},
{
  "id": "grader2",
  "level": "2",
  "url": "instructor-interface_grading.html#grader2",
  "type": "Figure",
  "number": "6.5.4",
  "title": "",
  "body": " Grader: Choose a Problem   "
},
{
  "id": "manual-grading",
  "level": "2",
  "url": "instructor-interface_grading.html#manual-grading",
  "type": "Figure",
  "number": "6.5.5",
  "title": "",
  "body": " Grader: Manual Grading   "
},
{
